...
namespace Assets.Scripts.Interaction.Input
{
    public sealed class CrosshairInteractor : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            UnityEngine.GUI.color = _hovering ? Color.green : Color.white;
            UnityEngine.GUI.DrawTexture(new Rect(centerX, centerY, CrosshairSize.x, CrosshairSize.y), CrosshairTexture);
        }
    }
}